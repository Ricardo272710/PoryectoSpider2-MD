...
//main.js
const smsWelcome = () => { return `╭━〔 𝙎𝙋𝙄𝘿𝙀𝙍 𝘽𝙊𝙏 〕━⬣
┃ Bienvenido Al Mejor Grupo De WhatsApp 👤\n┃ Nombre Del Grupo: @subject \n┃ Nuevo Usuario: @user
╰━━━━━━━━━━━━⬣`}
const smsBye = () => { return '╭━〔 𝙎𝙋𝙄𝘿𝙀𝙍 𝘽𝙊𝙏 〕━⬣
┃ Se Fue Del Mejor Grupo De WhatsApp 👤\n┃ -IGUAL NADIE TE NECESITABA AQUI 👿 @user'}
const smsSpromote = () => { return '𝙎𝙋𝙄𝘿𝙀𝙍 𝘽𝙊𝙏 𝗟𝗲 𝗗𝗶𝗼 𝗘𝗹 𝗣𝗼𝗱𝗲𝗿 𝗗𝗲 𝗦𝗲𝗿 𝗔𝗱𝗺𝗶𝗻 𝗔 : @user '}
const smsSdemote = () => { return '𝙎𝙋𝙄𝘿𝙀𝙍 𝘽𝙊𝙏 𝗟𝗲 𝗤𝘂𝗶𝘁𝗼 𝗘𝗹 𝗣𝗼𝗱𝗲𝗿 𝗗𝗲 𝗦𝗲𝗿 𝗔𝗱𝗺𝗶𝗻 𝗔 : @user '}
...
//_allantilink.js
const smsTextoYT = () => { return '〔 𝙎𝙋𝙄𝘿𝙀𝙍 𝘽𝙊𝙏 〕'} 
